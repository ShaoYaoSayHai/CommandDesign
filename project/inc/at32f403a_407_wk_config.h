...
/* Private defines -------------------------------------------------------------*/
#define LED_G_PIN    GPIO_PINS_11
#define LED_G_GPIO_PORT    GPIOA
#define LED_R_PIN    GPIO_PINS_12
#define LED_R_GPIO_PORT    GPIOA
#define DR1_PIN    GPIO_PINS_4
#define DR1_GPIO_PORT    GPIOB
#define DR2_PIN    GPIO_PINS_5
#define DR2_GPIO_PORT    GPIOB
